    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      >
        ...
        <div className="px-6 pt-4 pb-2 border-t border-zinc-800 shrink-0">
          ...
          <label className={`flex items-start gap-3 cursor-pointer group ${!hasScrolledToBottom ? "opacity-40 pointer-events-none select-none" : ""}`}>
            <input
              type="checkbox"
              checked={agreed}
