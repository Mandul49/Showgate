...
Entity Name: Showgate

Headquarters: Jos, Plateau State, Nigeria

Official Email: hello@showgate.ng
...
Right of Access: The right to request and obtain confirmation of whether we process your data, alongside a copy of that data.

Right to Rectification: The right to amend or correct inaccurate or incomplete personal records.

Right to Erasure ("Right to be Forgotten"): The right to request data deletion where statutory obligations do not supersede the request.

Right to Restriction of Processing: The right to suspend active data processing under specific verification conditions.

Right to Data Portability: The right to receive your personal data in a structured, machine-readable format for transfer to another controller.

Right to Object: The right to contest processing operations founded on our legitimate interests or direct marketing initiatives.

Right to Withdraw Consent: The right to revoke processing consent at any time, without affecting the lawfulness of processing handled prior to withdrawal.
...
The Platform utilizes cookies and similar tracking pixels to optimize user sessions, preserve system state preferences, analyze traffic trends, and implement anti-fraud defenses.
...
Showgate applies institutional, technical, and physical security measures designed to protect personal data against unauthorized access, alteration, disclosure, or destruction. Key protocols include:
End-to-end encryption of data in transit via HTTPS/TLS protocols.

Restricted database access controls utilizing enterprise-grade authentication via Supabase.
...
Email: hello@showgate.ng

Digital Portal: showgate.ng
...
Web Portal: ndpc.gov.ng

Official Correspondence: info@ndpc.gov.ng`;
