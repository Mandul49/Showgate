      ...
      <main className="max-w-7xl mx-auto px-3 sm:px-6 py-6 sm:py-8 space-y-5 sm:space-y-6">
        ...
        <div className="flex items-center justify-between gap-3">
          <div>
            ...
            <p className="text-xs sm:text-sm text-zinc-500 mt-0.5">All events across all organizers</p>
          </div>
          <div className="text-right flex-shrink-0">
            <div className="text-xl sm:text-2xl font-bold text-zinc-50">{events.length}</div>
